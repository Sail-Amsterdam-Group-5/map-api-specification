...
export class LocationsController {
  ...
  @ApiCreatedResponse({
    description: 'This action adds a new location',
    example: {
  ...
  @ApiOkResponse({
    description: 'This action returns all locations',
    example: [
      {
  ...
  @ApiOkResponse({
    description: 'This action returns a location',
    example: {
      id: '1dafsf3',
      location: {
        longitude: 51.985103,
  ...
  @ApiOkResponse({
    description: 'This action updates a location',
    example: {
      id: '14124',
      location: {
        longtitude: 51.985103,
